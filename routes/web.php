...
use App\Http\Controllers\BoatController; // Import Boat Controller
...
// 2. Registration Routes (Fixed Name Issue)
Route::get('/register', [CustomRegisterController::class, 'showForm'])->name('register');
Route::post('/register', [CustomRegisterController::class, 'register'])->name('register.post'); // Added name
